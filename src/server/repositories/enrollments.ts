...
export const enrollmentsRepository = {
  ...
  async toggleProgress(db: Queryable, enrollmentId: string, lessonId: string) {
    ...
    await db.query("INSERT INTO lesson_progress (id,enrollment_id,lesson_id,completed,completed_at) VALUES ($1,$2,$3,$4,$5)", [progress.id, enrollmentId, lessonId, 1, progress.completedAt]);
    return progress;
  }
};
